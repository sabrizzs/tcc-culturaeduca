...
parser.add_argument("--colunas_complemento_entrada", nargs="+", help="coluna de complemento do endereço do arquivo de entrada")
parser.add_argument("--colunas_complemento_cnefe", nargs="+", help="coluna de complemento do endereço do arquivo do cnefe")
...
colunas_complemento_entrada = args.colunas_complemento_entrada
colunas_complemento_cnefe = args.colunas_complemento_cnefe
...
df_resultados = comparar(
    ...
    colunas_complemento1=colunas_complemento_entrada,
    colunas_complemento2=colunas_complemento_cnefe,
