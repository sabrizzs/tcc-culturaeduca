...
arquivo_cnefe_normalizado = "/home/samantha/tcc-culturaeduca/source/nov25/api/teste/1_normalizacao/datasets_normalizados_atual/normalizado_sao_paulo_cnefe.csv" # dados dos arquivos do cnefe
...
def indexar_enderecos_elasticsearch(
    ...
    col_tipo_logradouro="tipo_logradouro_normalizado",
    ...
    try:
        ...
        if recreate:
            ...
            es.indices.create(index=index_name, mappings={
                "properties": {
                    ...
                    "tipo_logradouro_normalizado": {"type": "text"},
        ...
        for i, row in df.iterrows():
            ...
            tipo_logradouro = safe_str(row[col_tipo_logradouro])
            ...
            actions.append({
                ...
                "_source": {
                    ...
                    "tipo_logradouro_normalizado": tipo_logradouro,
