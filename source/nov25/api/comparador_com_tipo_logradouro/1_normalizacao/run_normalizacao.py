...
3. Salvar o dataset normalizado em csv.
"""
...
parser.add_argument("--coluna_tipo_logradouro_dataset", type=str, required=False, help="coluna de tipo de logradouro do arquivo do dataset, ex: rua, avenida")
...
coluna_tipo_logradouro_dataset = args.coluna_tipo_logradouro_dataset if args.coluna_tipo_logradouro_dataset else None
...
df_dataset_normalizado = normalizar_datasets(
    ...
    col_tipo_logradouro=coluna_tipo_logradouro_dataset,
...
pasta_resultados = "datasets_normalizados_atual"
